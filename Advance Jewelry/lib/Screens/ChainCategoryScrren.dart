...
class _ChaincategoryscrrenState extends State<Chaincategoryscrren> {
  bool isLoading = true;
     ...
     
{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Chains', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 24)),
